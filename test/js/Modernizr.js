...
window.Modernizr = function(a, b, c) {
			...
			for (var d = 0, e, f, h, i = a.length; d < i; d++) {
				...
				if (e) {
					...
					if (/^range$/.test(f) && l.style.WebkitAppearance !== c) {
						...
						g.removeChild(l)
					} else if (/^(search|tel)$/.test(f)) {
					} else if (/^(url|email)$/.test(f)) {
	...
	var d = "2.0.6", e = {}, f = true, g = b.documentElement, h = b.head || b.getElementsByTagName("head")[0], i = "modernizr", j = b.createElement(i), k = j.style, l = b.createElement("input"), m = ":)", n = Object.prototype.toString, o = " -webkit- -moz- -o- -ms- -khtml- ".split(" "), p = "Webkit Moz O ms Khtml".split(" "), q = {
		...
		(function(a, b) {
			...
			d.getCSS = function(a, b) {
				...
				while (++e < f) {
					...
					b = g.media || b;
					if (q.test(b))
						h.push(d.getCSS(g.imports, b), g.cssText);
					b = "all"
				}
				return h.join("")
			};
